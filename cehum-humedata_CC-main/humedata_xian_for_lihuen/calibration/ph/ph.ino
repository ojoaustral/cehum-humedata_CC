...
void loop() 
{
  if (Serial.available() > 0) {
    ...
    if(incomingString == "CAL7")
    {
      while((ph_received == 0) && (reading_tries < 5))
      {
        ...
        if(Serial1.available() > 0)
        {
          ...
          Serial.print(ph_cal_response[0], HEX); Serial.print(" ");
          Serial.print(ph_cal_response[1], HEX); Serial.print(" ");
          Serial.print(ph_cal_response[2], HEX); Serial.print(" ");
          Serial.print(ph_cal_response[3], HEX); Serial.print(" ");
          Serial.print(ph_cal_response[4], HEX); Serial.print(" ");
          Serial.print(ph_cal_response[5], HEX); Serial.print(" ");
          Serial.print(ph_cal_response[6], HEX); Serial.print(" ");
    ...
    else if((incomingString == "AYUDA") || (incomingString == "ayuda"))
    {
    ...
    else if((incomingString == "L") || (incomingString == "l"))
    {
      while((ph_received == 0) && (reading_tries < 5))
    {
      for(int i=0; i<8; i++)
    ...
    else if((incomingString == "param") || (incomingString == "PARAM"))
    {
      while((ph_received == 0) && (reading_tries < 5))
      {
        for(int i=0; i<8 ; i++)
    ...
    else if((incomingString == "ID") || (incomingString == "id"))
    {
      while((ph_received == 0) && (reading_tries < 5))
      {
        for(int i=0; i<8 ; i++)
