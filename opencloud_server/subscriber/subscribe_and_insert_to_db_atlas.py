#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Per-device copy of the subscriber, retrieved from the live OpenCloud server on 2026-09-24 (/home/subscribe_and_insert_to_db_atlas.py).
# Still run by humedata.service in 2026. Identical to subscribe_and_insert_to_db.py except that the device
