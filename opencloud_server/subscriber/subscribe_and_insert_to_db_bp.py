#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Per-device copy of the subscriber, retrieved from the live OpenCloud server on 2026-09-24 (/home/subscribe_and_insert_to_db_bp.py).
# Still run by humedatabp.service in 2026. Identical to subscribe_and_insert_to_db.py except that the device
# (TTN topic) and the MySQL credentials are hardcoded instead of read from argv and /home/log_in.
...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("v3/cehum-humedata@ttn/devices/humedata-bp/up")
